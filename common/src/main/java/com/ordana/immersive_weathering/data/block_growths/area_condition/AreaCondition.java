...
public interface AreaCondition {
    ...
    // 1.21 dispatch requires MapCodec<? extends T> on the inner codec.
    // AreaConditionType now holds a MapCodec; AreaCheck/NeighborCheck
    // build theirs via RecordCodecBuilder.mapCodec().
