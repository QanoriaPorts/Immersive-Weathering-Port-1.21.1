...
public interface Rustable extends ChangeOverTimeBlock<Rustable.RustLevel> {
    ...
    //same as the base one but has configurable radius. The parent
    //ChangeOverTimeBlock interface signature changed in 1.21.x; dropping
    //@Override since this is now an interface helper, not a vanilla override.
