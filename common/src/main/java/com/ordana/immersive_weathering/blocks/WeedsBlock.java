...
public class WeedsBlock extends CropBlock {
    ...
    public void randomTick(BlockState state, ServerLevel level, BlockPos pos, RandomSource random) {
        ...
        if (i < this.getMaxAge()) {
            // CropBlock.getGrowthSpeed in 1.21 has a NeoForge-patched signature
            // (BlockState vs vanilla Block); calling it from Architectury common
            // code crashes at runtime with NoSuchMethodError. Use the vanilla
            // default growth speed (1.0) which matches behavior on a clean tile.
