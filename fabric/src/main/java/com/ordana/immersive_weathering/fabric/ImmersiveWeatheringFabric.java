...
public class ImmersiveWeatheringFabric implements ModInitializer {
    ...
    public static void onSetup() {
        ...
        // NeoForge handles per-item burn times through a data-map; on Fabric we
        // drain the collector populated at registration time into FuelRegistry.
        ModBlocks.BURN_TIMES.forEach((item, time) -> FuelRegistry.INSTANCE.add(item.get(), time));
    }
